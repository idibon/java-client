...
public class FullDocumentSearchResponse implements Iterable<Document> {
	...
	public ArrayList<Document> getDocumentsAfterSearch() {
	...
	public Iterator<Document> iterator() {
		Iterator<Document> it = new Iterator<Document>() {
			private FullDocumentSearchResponse response;
			...
			public Document next() {
				if (retrieveMoreDocs()) {
					...
					try {
						response = client.getFullDocuments(collectionname,
								request);
